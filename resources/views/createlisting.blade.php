...
@section('content')
    ...
    <div class="col-md-12">
      <br>
      <form action="{{route('listings.store')}}" method="POST" class="needs-validation" novalidate>
        {{ csrf_field() }}
	      <div class="mb-3">
	        <label for="firstName">Listing Name</label>
	        <input type="text" class="form-control" id="firstName" placeholder="" value="" name="listing_name" required>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" id="username" placeholder="Username" name="listing_username" required>
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control" id="email" placeholder="listing@example.com" name="email">
          <div class="invalid-feedback">
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <select name="state" class="custom-select d-block w-100" id="state" name="state" required>
              @foreach($state as $s)
                <option>{{$s}}</option>
              @endforeach
            </select>
